...
Revision ID: 23fc6671ba94
Revises: 
Create Date: 2018-05-16 05:54:13.207828
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('todo', sa.String(length=75), nullable=False),
    sa.Column('desc', sa.String(length=150), nullable=True),
    sa.Column('mc_number', sa.Integer(), nullable=True),
    sa.Column('dnc_doc', sa.String(length=50), nullable=True),
    sa.Column('prog_edit', sa.String(length=50), nullable=True),
    sa.Column('status', sa.String(length=50), nullable=True),
    sa.Column('fal', sa.String(length=50), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'todo', name='todo_name')
    )
